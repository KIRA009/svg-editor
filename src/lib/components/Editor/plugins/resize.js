...
export class ResizeHandler {
    ...
    active(value, options) {
        ...
        this.el.on(
            ['lt.resize', 'rt.resize', 'rb.resize', 'lb.resize', 't.resize', 'r.resize', 'b.resize', 'l.resize', 'rot.resize', 'point.resize'],
            this.handleResize
        );
    ...
    handleResize(e) {
        ...
        if (this.el.dispatch('beforeresize', { event: e, handler: this, box: this.box, transform: this.el.transform() }).defaultPrevented) {
            return;
        }
